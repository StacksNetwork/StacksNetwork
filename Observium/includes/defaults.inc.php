...
$config['profile_sql'] = FALSE;        // Store MySQL quieries and performance data.
...
$config['web_url'] = 'http://observium.stacksnet.com:80/';

$config['title_image']       = "images/stacksnet-logo.png";
$config['title_url']         = "";
...
$config['page_title_prefix'] = "Observium :: 核心网络监控";
$config['timestamp_format']  = 'Y-m-d H:i:s';
$config['page_gen']          = 1;
$config['web_header']        = "header.inc.php";  // in html/includes
$config['login_message']     = "未经授权的访问可能会对恶意用户采取刑事或民事诉讼.";
...
$config['frontpage']['minigraphs']['title']        = "缩略图概述";
...
#$config['rancid_suffix']                = 'vmware.city'; // Domain suffix for non-FQDN device names
...
#$config['smokeping']['suffix']          = ".vmware.city";

// NFSen RRD dir.
$config['nfsen_enable'] = 0;
#$config['nfsen_split_char']   = "_";
#$config['nfsen_rrds']   = "/var/nfsen/profiles-stat/live/";
#$config['nfsen_suffix']   = "_vmware_city";
...
$config['auth_ldap_server'] = "ldap.stacksnet.com";  // LDAP server name
$config['auth_ldap_port']   = 389;                    // LDAP server port
$config['auth_ldap_starttls'] = 'no';                 // Use STARTTLS ('no', 'optional' or 'require')
$config['auth_ldap_prefix'] = "uid=";
$config['auth_ldap_suffix'] = ",ou=People,dc=stacksnet,dc=com";
$config['auth_ldap_group']  = array("cn=observium,ou=groups,dc=stacksnet,dc=com");
