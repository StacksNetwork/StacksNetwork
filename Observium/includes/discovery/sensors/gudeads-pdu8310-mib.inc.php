...
for ($index = 1;$index <= $channels;$index++)
{
  ...
  if ($value != '' && $value != -9999)
  {
    discover_sensor($valid['sensor'], 'voltage', $device, $oid, "pdu8310Voltage.$index", 'pdu8310', $descr, 1, 1, NULL, NULL, NULL, NULL, $value);
  }
  ...
  if ($value != '' && $value != -9999)
  {
    discover_sensor($valid['sensor'], 'power', $device, $oid, "pdu8310PowerActive.$index", 'pdu8310', $descr, 1, 1, NULL, NULL, NULL, NULL, $value);
  }
  ...
  if ($value != '' && $value != -9999)
  {
    discover_sensor($valid['sensor'], 'apower', $device, $oid, "pdu8310PowerApparent.$index", 'pdu8310', $descr, 1, 1, NULL, NULL, NULL, NULL, $value);
  }
  ...
  if ($value != '' && $value != -9999)
  {
    discover_sensor($valid['sensor'], 'frequency', $device, $oid, "pdu8310Frequency.$index", 'pdu8310', $descr, 100, 1, NULL, NULL, NULL, NULL, $value / 100);
  }
  ...
  if ($value != '' && $value != -9999)
  {
    discover_sensor($valid['sensor'], 'current', $device, $oid, "pdu8310Current.$index", 'pdu8310', $descr, 1000, 1, NULL, NULL, NULL, NULL, $value / 1000);
  }
}
