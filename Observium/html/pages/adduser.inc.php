  ...
  if (auth_usermanagement())
  {
    if ($_POST['action'] == "add")
    {
      if ($_POST['new_username'])
      {
        ...
        $errors["username"] = "<span class=\"help-inline\">请输入用户名!</span>";
      }

      if (!$_POST['new_password'])
      {
        $errors["passwd"] = "<span class=\"help-inline\">请输入密码</span>";
      }
    }
        ...
        <fieldset>
          ...
          <div class="control-group<?php if (isset($errors["passwd"])) { echo " error"; } ?>">
            ...
            <div class="controls">
              ...
              <input type="checkbox" checked="checked" name="can_modify_passwd"> 允许用户修改密码.
            </div>
          </div>
...
<?php
    ...
    echo("<div class=\"alert alert-error\">验证模块不允许进行用户管理!</div>");
  }
} else {
