  ...
  <tr class="small">
    <td colspan=3>
      <span class="pull-right">
         <?php echo("<strong>已用</strong> <strong style='color:#".$background['left'].";'>$used ($percent%)</strong> / <strong>空闲</strong> <strong style='color:#".$background['right'].";'>$free (".(100 - $percent) . "%)</strong> / <strong>Total</strong> <strong>$total</strong>"); ?>
      </span>
    </td>
  </tr>
