...
?>
<h2 style="padding: 0 10px;">本地 AS : <?php echo($device['bgpLocalAs']); ?></h2>
...
$bgp_graphs = array('unicast'   => array('text' => '单播'),
                    //'multicast' => array('text' => '组播'),
                    'mac'       => array('text' => 'MACaccounting'));
$bgp_graphs['unicast']['types'] = array('prefixes_ipv4unicast' => 'IPv4 单播前缀',
                                        'prefixes_ipv6unicast' => 'IPv6 单播前缀',
                                        'prefixes_ipv4vpn'     => 'VPNv4 前缀');
//$bgp_graphs['multicast']['types'] = array('prefixes_ipv4multicast' => 'IPv4组播前缀',
//                                          'prefixes_ipv6multicast' => 'IPv6组播前缀');
...
echo('<thead>');
echo('<tr><th></th><th></th><th>对等地址</th><th>类型</th><th>AFI.SAFI</th><th>远端 AS</th><th>状态</th><th>运行时间</th></tr>');
echo('</thead>');
