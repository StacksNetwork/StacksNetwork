...
echo('  <thead>');
echo('    <tr>');
echo('      <th width="250"><a href="'. generate_url($vars, array('sort' => 'hostname')).'">设备</a></th>');
echo('      <th><a href="'. generate_url($vars, array('sort' => 'mountpoint')).'">挂载点</a></th>');
echo('      <th><a href="'. generate_url($vars, array('sort' => 'size')).'">大小</a></th>');
echo('      <th><a href="'. generate_url($vars, array('sort' => 'used')).'">已用</a></th>');
echo('      <th><a href="'. generate_url($vars, array('sort' => 'free')).'">空余</a></th>');
echo('      <th></th>');
echo('      <th width="200"><a href="'. generate_url($vars, array('sort' => 'usage')).'">使用 %</a></th>');
echo('    </tr>');
echo('  </thead>');
