    ...
    <div class="container">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="dropdown"><a href="https://www.stacksnet.com" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><?php echo $config['product']; ?> <?php echo $config['version']; ?></a>
            <div class="dropdown-menu" style="padding: 10px;">
              <div><img src="/images/login-hamster-large.png" alt="" /></div>
...
?>
  ...
  jQuery(document).ready(function($) {
    ...
    $('.entity-popup').each(function() {
        ...
        content:{
            text: '<img class="" src="images/loading.gif" alt="加载中..." />',
            ajax:{
