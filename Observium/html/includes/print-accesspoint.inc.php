...
echo("<img src='images/icons/wireless.png' align=absmiddle /> ".format_bi($ap['radioutil'])." % 繁忙<br />");
echo("<img src='images/icons/wireless.png' align=absmiddle /> ".format_bi($ap['interference'])." 干扰指数<br />");

echo("</td></tr>");

if ($vars['tab'] == "accesspoint")
{
    $graphs = array('accesspoints_numasoclients' => '相关的客户',
                    'accesspoints_interference' => '干扰',
                    'accesspoints_channel' => '频道',
                    'accesspoints_txpow' => '传输功率',
                    'accesspoints_radioutil' => '广播应用',
                    'accesspoints_nummonclients' => '监控客户端',
                    'accesspoints_nummonbssid' => '监测BSSIDs');
