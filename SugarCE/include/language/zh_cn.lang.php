...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
  ...
  array (
    ...
    'Campaigns'=>'市场活动',
    'Documents'=>'文档',
    'SugarFollowing'=>'STACKS®如下',
    'Sync'=>'同步',
    'Users' => '用户',
	'SugarFavorites'=>'STACKS®收藏'
...
$app_strings = array (
  ...
  'LBL_TOUR_BACK' => '后退',
  'LBL_TOUR_CLOSE' => '关闭',
  'LBL_TOUR_TAKE_TOUR' => '浏览',
  'LBL_MY_AREA_LINKS' => '我的区域链接: ' /*for 508 compliance fix*/,
  'LBL_GETTINGAIR' => '好戏开始了' /*for 508 compliance fix*/,
  ...
  'LBL_JS_CALENDAR' => '日历' /*for 508 compliance fix*/,
    'LBL_ADVANCED' => '高级',
    'LBL_BASIC' => '基本',
    'LBL_MODULE_FILTER' => '过滤',
    'LBL_CONNECTORS_POPUPS'=>'弹出连接',
    'LBL_CLOSEINLINE'=>'关闭',
    'LBL_MOREDETAIL'=>'更多详情',
    'LBL_EDITINLINE'=>'编辑',
    'LBL_VIEWINLINE'=>'查看',
    'LBL_INFOINLINE'=>'信息',
    'LBL_POWERED_BY_SUGARCRM' => "Powered by STACKS® CRM",
    'LBL_PRINT' => "打印",
    'LBL_HELP' => "帮助",
    'LBL_ID_FF_SELECT' => "选择",
    'DEFAULT'                              => '普通',
    ...
    'LBL_ROUTING_ACTIONS_DELETE_BEAN'       => '删除STACKS®对象',
    ...
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME'      => 'STACKS®文件夹名一定是唯一的. ',
    ...
    'LBL_EMAIL_IMPORT_EMAIL'                => '导入到STACKS®',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER'        => '创建一个文件夹 (远程或在STACKS®中)',
    'LBL_EMAIL_MENU_HELP_ARCHIVE'           => '在STACKS® CRM激活这些邮件',
    ...
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER'     => '删除一个文件 (远程或在STACKS®中)',
    ...
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER'     => '重命名一个文件夹 (远程或在STACKS®中)',
    ...
    'LBL_EMAIL_SUBSCRIPTION_FOLDER_HELP'    => '按[Shift]键或[Ctrl]键来选在多个文件夹. ',
    ...
    'LBL_EMAIL_SPACER_LOCAL_FOLDER'         => '[STACKS® 文件夹]',
    'LBL_EMAIL_SUBJECT'                     => '主题',
    'LBL_EMAIL_TO'                     		=> '到',
    'LBL_EMAIL_SUCCESS'                     => '成功',
    'LBL_EMAIL_SUGAR_FOLDER'                => 'STACKS®文件夹',
    ...
    'ERR_AJAX_LOAD'     => '发生了一个错误:',
    'ERR_AJAX_LOAD_FAILURE'     => '处理您的请求时出错, 请稍后再试.',
    'ERR_AJAX_LOAD_FOOTER' => '如果错误仍然存在, 请您的管理员禁用此模块的AJAX',
    ...
    'ERR_POTENTIAL_SEGFAULT' => '检测到一个Apache潜在的分割故障. 请通知您的系统管理员来确认这个问题, 让他报告给STACKS® CRM. ',
    ...
    'ERR_DB_VERSION' => 'STACKS® CRM {0} 文件可能只适用于 STACKS® CRM {1} 数据库.',
    ...
    'LBL_BROWSER_TITLE' => 'STACKS® CRM–商业开源客户关系管理系统',
    'LBL_BUGS'=>'缺陷追踪',
    'LBL_BY' => '被',
    'LBL_CALLS'=>'电话',
    'LBL_CALL'=>'电话',
    ...
    'LBL_FAVORITES' => '收藏夹',
    'LBL_FILTER_MENU_BY' => '过滤',
    'LBL_VCARD' => 'vCard',
    'LBL_EMPTY_VCARD' => '请选择一个 vCard 文件',
    'LBL_EMPTY_REQUIRED_VCARD' => 'vCard 没有这个模块所需的所有字段. 请参阅sugarcrm.log详情.',
    'LBL_VCARD_ERROR_FILESIZE' => '上传的文件超过30000个字节大小的限制, 是在指定的HTML表单.',
    'LBL_VCARD_ERROR_DEFAULT' => '有一错误的vCard文件上传. 请参考到sugarcrm.log详情.',
    ...
    'LBL_GS_HELP' => '在本模块中使用这个搜索领域出现以上. 突出显示的文本匹配您的搜索条件.',
    'LBL_HIDE'=>'隐藏',
    'LBL_ID'=>'编号',
    'LBL_IMPORT' => '导入',
    ...
    'LBL_NO_MASS_UPDATE_FIELDS_AVAILABLE' => '没有有可用于批量更新操作的字段',
    ...
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE' => '选择账号',
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL' => '选择账号',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_KEY' => ' ',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE' => '清除账号',
    'LBL_ACCESSKEY_CLEAR_ACCOUNTS_LABEL' => '清除账号',
    ...
    'LBL_SERVER_MEMORY_USAGE' => '服务器的内存使用情况: {0} ({1})',
    'LBL_SERVER_MEMORY_LOG_MESSAGE' => '用法: - 模块: {0} - 活动: {1}',
    'LBL_SERVER_PEAK_MEMORY_USAGE' => '服务器的内存使用峰值: {0} ({1})',
    ...
    'LBL_SUGAR_COPYRIGHT' => '&copy; 2004-2011 STACKS® CRM Inc. The Program is provided AS IS, without warranty. Licensed under <a href="LICENSE.txt" target="_blank" class="copyRightLink">AGPLv3</a>.<br />保留所有权利',



    // The following version of LBL_SUGAR_COPYRIGHT is for Professional and Enterprise editions.

    'LBL_SUGAR_COPYRIGHT_SUB' => '&copy; 2004-2011 <a href="http://www.sugarcrm.com" target="_blank" class="copyRightLink">STACKS® CRM Inc.</a>保留所有权利. ',
    ...
    'LNK_SEARCH_FTS_VIEW_ALL' => '查看所有的结果',
    ...
    'NTC_REQUIRED' => '表示必填字段',
    'NTC_SUPPORT_SUGARCRM' => '支持STACKS® CRM开源项目, 通过Paypal捐赠它. -它是快速、免费和安全的软件！',
    'NTC_TIME_FORMAT' => '(24:00)',
    'NTC_WELCOME' => '欢迎',
    'NTC_YEAR_FORMAT' => '(yyyy)',
    'LOGIN_LOGO_ERROR'=> '请更换STACKS® CRM标识. ',
    'ERROR_LICENSE_FULLY_EXPIRED'=> "您公司STACKS® CRM的许可已经超期30天以上,需要进行修订.只有管理员可以登陆",
    'ERROR_LICENSE_EXPIRED'=> "您公司STACKS® CRM的许可需要被更新,只有管理员可以登陆",
    'ERROR_LICENSE_VALIDATION'=> "您公司STACKS® CRM的许可需要被验证. 只有管理员可以登陆",
    'WARN_BROWSER_VERSION_WARNING' => "<b>警告:</b> 你的浏览器的版本不再支持或你使用不支持的浏览器.<p></p>以下是推荐的浏览器版本:<p></p><ul><li>Internet Explorer 10 (兼容性视图不支持)<li>Firefox 24.0<li>Safari 5.1<li>Chrome 29</ul>",
    'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING' => "<b>警告:</b> 你的浏览器是IE兼容性视图不支持.",
    ...
    'MSG_JS_ALERT_MTG_REMINDER_RELATED_TO' => '相关的: ',
    'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => "\n点击“确定”来查看这条消息, 或者点击“取消”放弃查看这条消息. ",
	'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\n点击确定来查看会议或点击取消来放弃查看消息",
 	'MSG_LIST_VIEW_NO_RESULTS_BASIC' => "没有找到任何结果.",
	'MSG_LIST_VIEW_NO_RESULTS' => "没有找到结果关于 <item1>",
 	'MSG_LIST_VIEW_NO_RESULTS_SUBMSG' => "建立 <item1> 作为一种新的 <item2>",
	'MSG_EMPTY_LIST_VIEW_NO_RESULTS' => "您目前没有记录保存. <item2> 或 <item3> 现在.",
	'MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG' =>	"<item4> 了解更多关于 <item1> 模块. 为了获得更多的信息, 使用位于主导航栏下的用户菜单连接帮助.",
    ...
    'LBL_CREATING_NEW_PAGE' => '创建新页面 ...',
    'LBL_NEW_PAGE_FEEDBACK' => '您已经创建了一个新页面. 您将使用添加新增栏目选项添加新内容. ',
    'LBL_DELETE_PAGE_CONFIRM' => '您确定您要删除本页吗?',
    'LBL_SAVING_PAGE_TITLE' => '保存页标题 ...',
    'LBL_RETRIEVING_PAGE' => '恢复页面 ...',
    'LBL_MAX_DASHLETS_REACHED' => '您已经达到管理员设置新增栏目的最大值. 请移除一个STACKS®栏目后再添加. ',
    'LBL_ADDING_DASHLET' => '添加STACKS®新增栏中 ...',
    'LBL_ADDED_DASHLET' => '已经添加的新增栏目',
    'LBL_REMOVE_DASHLET_CONFIRM' => '您确定您想要删除新增的栏目吗?',
    'LBL_REMOVING_DASHLET' => '删除新增栏目中 ...',
    'LBL_REMOVED_DASHLET' => '新增栏目已删除',
    ...
    'LBL_SEARCH_RESULTS_FOUND' => '发现搜索结果',
    'LBL_SEARCH_RESULTS_TIME' => 'ms.',
    'ERR_BLANK_PAGE_NAME' => '请输入页面名称. ',
    ...
    'LBL_BREADCRUMBSTACK_CREATED' => 'BreadCrumbStack 创建的用户 {0}',
    'LBL_VISIBLE' => '记录可见',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => '欢迎来到STACKS®门户 5.1.0',
    'LBL_PORTAL_WELCOME_INFO' => 'STACKS® Portal是一个给客户提供实时的客户反馈,缺陷追踪和新闻订阅到框架.它是一个面对STACKS®的内部接口, 且可部署到任何Web站点上. 持续的为客户自助服务,例如项目管理和论坛进行调整优化. ',
    'LBL_LIST' => '列表',
    ...
    'LBL_CHOOSE_START_AND_END_ENTRIES' => '请选择起始和结束范围内的条目',
	...
	'ERROR_UNABLE_TO_RETRIEVE_DATA' => '错误: 连接器不能获得数据. 服务现在可能无法进入或配置设置无效. 连接器错误信息: ({1}).',
    ...
    'ERR_RSS_INVALID_INPUT' => 'RSS不是有效的输入类型',
...
"这是一个样品导入文件所提供的文件，准备导入期望的内容为例."
"这个文件是逗号分隔. CSV文件,使用双引号作为字段限定符."

"标题行在文件的顶部包含最行和字段标签你会看到他们的应用."
"这些标签是用来映射文件中的数据在应用领域."

"注: 数据库名称,也可以用在标题行. 这是有用的当您使用phpMyAdmin或另一个数据库工具提供一个出口,进口数据列表."
"该柱的顺序是不重要的过程数据的进出场比赛基于适当的标题行."
...
"3. 输入你自己的数据到相应的行和列"
"4. 将文件保存到你的系统上的已知位置"
"5. 从应用程序中的操作菜单的导入选项并选择要上传的文件单击"
   ',
    //define labels to be used for overriding local values during import/export
    'LBL_EXPORT_ASSIGNED_USER_ID' => '分配',
    'LBL_EXPORT_ASSIGNED_USER_NAME' => '指定的用户',
    'LBL_EXPORT_REPORTS_TO_ID' => '报告编号',
    'LBL_EXPORT_FULL_NAME' => '姓名',
    'LBL_EXPORT_TEAM_ID' => '团队编号',
    'LBL_EXPORT_TEAM_NAME' => '团队',
    'LBL_EXPORT_TEAM_SET_ID' => '团队设定ID',

    'LBL_QUICKEDIT_NODEFS_NAVIGATION'=> '导航... ',

    'LBL_PENDING_NOTIFICATIONS' => '通知',
    'LBL_ALT_ADD_TEAM_ROW' => '添加新的团队列',
    'LBL_ALT_REMOVE_TEAM_ROW' => '移除团队',
    'LBL_ALT_SPOT_SEARCH' => '现场搜索',
    'LBL_ALT_SORT_DESC' => '按降序排序',
    'LBL_ALT_SORT_ASC' => '按升序排序',
    'LBL_ALT_SORT' => '排序',
    'LBL_ALT_SHOW_OPTIONS' => '显示选项',
    'LBL_ALT_HIDE_OPTIONS' => '隐藏选项',
    'LBL_ALT_MOVE_COLUMN_LEFT' => '移动选定的条目左侧的列表',
    'LBL_ALT_MOVE_COLUMN_RIGHT' => '移动选定的进入右侧的列表',
    'LBL_ALT_MOVE_COLUMN_UP' =>'在显示的列表顺序上移选定条目',
    'LBL_ALT_MOVE_COLUMN_DOWN' => '在显示的列表顺序向下移动选定的项目',
    'LBL_ALT_INFO' => '信息',
    ...
    'LBL_EMAIL_PRIM_TITLE' => '主要的电子邮件地址',
    'LBL_SELECT_ALL_TITLE' => '选择所有',
    'LBL_SELECT_THIS_ROW_TITLE' => '选择这行',
    'LBL_TEAM_SELECTED_TITLE' => '团队选择 ',
    'LBL_TEAM_SELECT_AS_PRIM_TITLE' => '选择使这个团队成为主要的',

    //for upload errors
    'UPLOAD_ERROR_TEXT'          => 'ERROR: 在上传时有一个错误. 错误代码: {0} - {1}',
    'UPLOAD_ERROR_TEXT_SIZEINFO' => 'ERROR: 在上传时有一个错误. 错误代码: {0} - {1}. 最大上传限制为 {2} ',
    'UPLOAD_ERROR_HOME_TEXT'     => 'ERROR: 你在上传时有一个错误, 请联系管理员帮助',
    'UPLOAD_MAXIMUM_EXCEEDED'    => '上传大小 ({0} 字节) 超过允许的最大值: {1} 字节',
    'UPLOAD_REQUEST_ERROR'    => '发生了一个错误, 请刷新页面重试.',
    ...
    'LBL_KEYBOARD_SHORTCUTS_HELP_TITLE' => '关键点',
    'LBL_KEYBOARD_SHORTCUTS_HELP' => '<p><strong>功能形式 - Alt+</strong><br/> I = ed<b>I</b>t (详细视图)<br/> U = d<b>U</b>plicate (详细视图)<br/> D = <b>D</b>elete (详细视图)<br/> A = s<b>A</b>ve (详细信息视图)<br/> L = cance<b>L</b> (详细信息视图) <br/><br/></p><p><strong>搜索和导航  - Alt+</strong><br/> 7 = 首先输入的编辑表格<br/> 8 = 高级搜索<br/> 9 = 首先搜索表单输入<br/> 0 = 统一检索输入<br></p>' ,

    'ERR_CONNECTOR_NOT_ARRAY' => '连接器阵列在{0}被定义不正确或是空的, 不能使用.',
    'ERR_SUHOSIN' => '上传流被截断 by Suhosin, 请添加 &quot;upload&quot; to suhosin.executor.include.whitelist (更多信息见sugarcrm.log)',
    'ERR_BAD_RESPONSE_FROM_SERVER' => '服务器的错误的回复',
    );
...
$app_list_strings['kbdocument_status_dom'] = array (
  ...
  $app_strings['LBL_CREATE_KB_DOCUMENT'] = '创建文档';
...
$app_strings ['documentation'] = array (
    'LBL_DOCS' => '文档',
    'ULT' => '02_STACKS®_Ultimate',
	'ENT' => '02_STACKS®_Enterprise',
	'CORP' => '03_STACKS®_Corporate',
	'PRO' => '04_STACKS®_Professional',
	'COM' => '05_STACKS®_Community_Edition'
);
?>
