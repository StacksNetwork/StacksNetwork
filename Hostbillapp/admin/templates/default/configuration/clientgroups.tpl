...
<div id="blank_state" class="blank_state blank_news">
    <div class="blank_info">
        <h1>整理您的客户进入用户组</h1>
        将您需要优先服务的客户放到同一个用户组并获得额外的折扣优惠, 自动化设置和更多-所有可能的用户组.
        <br/>注意: 所有的客户默认将分配到 "None" 组
        <div class="clear"></div>
...
<div style="padding:15px;background:#F5F9FF;">
    <table width="100%" cellspacing="0" cellpadding="3" border="0" style="border:solid 1px #ddd;" class="whitetable">
        <tbody>
            <tr>
                <th align="left" colspan="4">当前用户组</th>
            </tr>
            ...
            <tr class="havecontrols  ">
                ...
                <td width="60"><a href="?cmd=clients&list={$group.id}" class="fs11" target="_blank">{$group.count} 名客户</a></td>
                <td width="23" align="center"><a class="delbtn" href="?cmd=clients&action=groups&make=delete&id={$group.id}&security_token={$security_token}" onclick="return confirm('您确定吗? 所有该用户组下的客户都将被分配回(None)组')">删除</a></td>
            </tr>
            {/foreach}
...
<form action="" method="post" id="sme">
    <div id="newshelfnav" class="newhorizontalnav">
        <div class="list-1">
            <ul>
                ...
                <li class="">
                    <a href="#"><span class="ico money">订购设置</span></a>
                </li>
                <li class="">
                    <a href="#"><span class="ico money">自动设置</span></a>
                </li>
                <li class="">
    ...
    <div style="padding:15px;background:#F5F9FF;">
        <div class="sectioncontent">
            <table width="100%" cellspacing="0" cellpadding="6">
                <tbody >
                    ...
                    <tr >
                        <td width="160" align="right"><strong>用户组颜色<a class="vtip_description" title="该组成员将被排列为这个颜色"></a></strong></td>
                        <td class="editor-container">
                     ...
                     <tr >
                        <td width="160" align="right"><strong>工单优先级 <a class="vtip_description" title="选择您希望给予该用户组提交工单时的优先级设置"></a></strong></td>
                        <td class="editor-container">
                    ...
                    <tr >
                        <td width="160" align="right"><strong>仅管理员可用说明</strong></td>
                        <td class="editor-container">
        ...
        <div class="sectioncontent" style="display:none">
            <table width="100%" cellspacing="0" cellpadding="6">
                <tbody >
                    <tr >
                        <td width="160" align="right"><strong>订单场景<a class="vtip_description" title="您可以选择将该用户组的客户应用默认场景, 或进行自定义"></a></strong></td>
                        <td class="editor-container">
                            <select name="scenario_id" class="inp">
                                <option value="0" {if $groupx.scenario_id=="0"}selected="selected"{/if}>使用默认场景</option>
                    ...
                    <tr>
                        <td align="right">
                            <strong>推行按比例收费</strong>
                            <a href="#" class="vtip_description" title="启用该选项, 在收取用户费用时, 如果多份账单则会集中于一个月内的某一天来收取. 避免用户感到麻烦." ></a>
                        </td>
                        <td>
                ...
                <tbody >
                    ...
                    <tr class="odd"> <td align="right" valign="top" width="200"><strong>{$lang.auto_create}</strong></td>
                        ...
                        <td >
                            ...
                            <input type="checkbox" name="settings_enabled[EnableAutoCreation]" class="toc" value="1" {if $groupx.settings_enabled.EnableAutoCreation}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置

                            <div class="contener">
                        <input type="radio" value="0" name="settings[EnableAutoCreations]" {if $groupx.settings.EnableAutoCreation=='0'}checked="checked"{/if} id="autooff" onclick="$('#autosetup_opt').hide();$('#autooff_').click();"/><label for="autooff"><b>{$lang.no}</b></label>
                    ...
                    <tr >
                        <td width="200" valign="top" align="right"><strong>账户冻结</strong></td>
                        <td class="editor-container">
                            <input type="checkbox" name="settings_enabled[EnableAutoSuspension]" class="toc" value="1" {if $groupx.settings_enabled.EnableAutoSuspension}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置
                                   <div class="contener">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="settings_enabled[EnableAutoTermination]" class="toc" value="1" {if $groupx.settings_enabled.EnableAutoTermination}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置
                                   <div class="contener">
	...
	{$lang.new_EnableAutoTermination1} <input type="text" size="3" value="{$groupx.settings.AutoTerminationPeriod}" name="settings[AutoTerminationPeriod]"  class="inp config_val" /> {$lang.new_EnableAutoTermination2}
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="settings_enabled[InvoiceGeneration]" class="toc" value="1" {if $groupx.settings_enabled.InvoiceGeneration}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置
                    ...
                    <td>
                         <input type="checkbox" name="settings_enabled[AdvancedDueDate]" class="toc" value="1" {if $groupx.settings_enabled.AdvancedDueDate}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置
                                   <div class="contener p5" >
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="settings_enabled[SendPaymentReminderEmails]" class="toc" value="1" {if $groupx.settings_enabled.SendPaymentReminderEmails}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置
                                   <div class="contener">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="settings_enabled[LateFeeType]" class="toc" value="1" {if $groupx.settings_enabled.LateFeeType}checked="checked"{/if} /> 覆盖对应该用户组的套餐设置
                                   <div class="contener">
                ...
                {foreach from=$groupx.discounts item=discount name=fl}
                    <tr id="discount_{$smarty.foreach.fl.index}">
                        ...
                        <input type="hidden" name="discounts[{$smarty.foreach.fl.index}][product_id]" value="{if $discount.rel=='Category'}cat_{else}prod_{/if}{$discount.rel_id}'"/>
                         ...
                         <td width="40"><a href="#" class="editbtn editgray" onclick="removeDiscount('{$smarty.foreach.fl.index}');">删除</a></td>
                     </tr>
    ...
    <tbody><tr>
    <td width="100" class="fs11"><span class="left">新折扣分类/产品</span></td>
                    ...
                    {foreach from=$services item=category}
                        {if $category.products}
                            <optgroup label="{$category.name}">
                             <option value="cat_{$category.id}" >{$category.name} - 整个分类</option>
...
<td>
<a onclick="addDiscount();return false;" class="prices menuitm " href="#"><span class="addsth">添加</span></a>
</td>
</tr>
</tbody></table>
        ...
        <a class="new_dsave new_menu" href="#" onclick="$('#sme').submit();return false"  >
    ...
    <script>
        ...
        var addDiscount= function() {
            ...
            var html='<tr id="discount_'+id+'">'+
                     ...
                     '<td width="40"><a href="#" class="editbtn editgray" onclick="removeDiscount('+id+');">删除</a></td>'+
                     '</tr>';
