                                ...
                                <tr>
                                    <td style="width:828px;">
                                        <ul class="mainer" id="mmcontainer">
                                            ...
                                            <li class="extras"><a class="mainmenu" href="?cmd=paidaddons" style="color:#EACC52">
                                                    <span class="second extras">付费应用</span>
                                                </a></li>

                                            <li class="extras"><a class="mainmenu" href="http://hostbillcs.com" target="_blank"  style="color:#EACC52">
                                                    <span class="second extras">自定义资源</span>
                                                </a></li>
                                        </ul>
...
position:relative;" id="search_form_container" class="search_form_container">
                                            <small style="color:#fff;" title="您可以使用 &quot; * &quot; 在搜索查询作为通配符" >
                                                {$lang.smartsearch} 
                                            </small>
                          ...
                          <ul class="submenu megadropdown">
                                                        ...
                                                        <div  class="popover">
                                                            <div class="popover-content">
                                                                <ul class="subbmenu">
                                                                    ...
                                                                    <li ><a href="?cmd=tickets&list=Client-Reply&showall=true">客户回应的工单</a></li>
                                                                    <li ><a href="?cmd=tickets&action=new" >开启新的工单</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </li>
                            ...
                            <ul class="submenu megadropdown">
                                ...
                                <li ><a href="?cmd=invoices">{$lang.Invoices}</a><div  class="popover">
                                        <div class="popover-content">
                                            <ul class="subbmenu">
                                                <li ><a href="?cmd=invoices&amp;list=paid&amp;showall=true">支付账单</a></li>
                                                <li ><a href="?cmd=invoices&amp;list=unpaid&amp;showall=true">未付账单</a></li>
                                                <li ><a href="?cmd=invoices&amp;list=refunded&amp;showall=true">退款账单</a></li>
                                                    ...
                                                    <div  class="popover">
                                                        <div class="popover-content">
                                                            <ul class="subbmenu">
                                                                ...
                                                                <li ><a href="?cmd=orders&amp;list=pending">待处理订单</a></li>
                                                                <li ><a href="?cmd=orders&amp;list=fraud">欺诈的订单</a></li>
                                                                <li ><a href="?cmd=orders&action=createdraft">创建订单</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
                                                        ...
                                                        <div  class="popover">
                                                            <div class="popover-content">
                                                                <ul class="subbmenu">
                                                                    ...
                                                                    <li ><a href="?cmd=accounts&amp;list=all_pending" >待处理 </a></li>
                                                ...
                                                <li ><a href="?cmd=domains">{$lang.Domains}</a><div  class="popover">
                                                        <div class="popover-content">
                                                            <ul class="subbmenu">
                                                                ...
                                                                <li ><a href="?cmd=domains&amp;list=pending" >待处理 </a></li>
                                                                <li ><a href="?cmd=domains&amp;list=expired" >过期 </a></li>
                                                    ...
                                                    <div  class="popover">
                                                        <div class="popover-content">
                                                            <ul class="subbmenu">
                                                                    ...
                                                                    <li><a href="?cmd=configuration&amp;action=cron">任务列表</a></li>
