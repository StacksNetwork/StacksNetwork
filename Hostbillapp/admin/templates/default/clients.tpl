...
function cancelsubmit1() {
    ...
    return false;
                                ...
                                {/literal}
                                <a onclick="return sendtoall_show()" class="menuitm" href="#"    style="margin-right: 30px;font-weight:bold;"><span >{$lang.sendmassemail}</span></a>
                                        ...
                                        <table border="0" width="90%" cellspacing="5" cellpadding="0">
                                            ...
                                            {if $smarty.foreach.floop.index%3==0}<tr>{/if}
                                                ...
                                                {elseif $field.type=='Private'}class="ispr" style="{if $client.company=='1'}display:none{/if}" {else}{/if}><span class="livemode" >
                                                        ...
                                                        {/if}
                                                    {/if}</span>{if $field.code=='email'}<span class='copytext' data-clipboard-target="field_live_{$field.code}">Copy</span>{/if}</td>
                                    ...
                                    <div id="detcont">
                                        <div class="tdetails">
                                            <table border="0" width="100%" cellspacing="5" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td width="25%" align="right" class="light">防止自动冻结/终止:</td>
