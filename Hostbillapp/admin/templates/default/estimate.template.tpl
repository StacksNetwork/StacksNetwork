                    ...
                    <div class="list-2">
                        <div class="subm1 haveitems">
                            <ul >
                                ...
                                <li class="list-2elem picked" ><a href="?cmd=configuration&action=estimatetemplates"><span>统计自定义化</span></a></li>
                                ...
                                <li class="list-2elem"><a href="?cmd=configuration&picked_tab=3&picked_subtab=3"><span>Credit notes</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
