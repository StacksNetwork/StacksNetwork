...
{if $enableFeatures.profiles=='on'}<div class="slide">Loading</div>{/if}{if $enableFeatures.estimates=='on'}<div class="slide">Loading</div>{/if}
        ...
        <ul class="tabs" id="tabbedmenu">
            ...
            {if $bandwidthtab}<li class="tpicker"><a href="#tab2" onclick="return false">带宽</a></li>{/if}
             <li class="tpicker"><a href="#tab2" onclick="return false">IPAM</a></li>
            {if $dedimgr}            <li class="tpicker"><a href="#tab2" onclick="return false">设备管理</a></li> {/if}
            {if $switch}            <li class="tpicker"><a href="#tab2" onclick="return false">交换机</a></li> {/if}
            {if $pdu}            <li class="tpicker"><a href="#tab2" onclick="return false">PDU</a></li> {/if}
            <li class="tpicker"><a href="#tab3" onclick="return false">增值业务<span id="numaddons" class="top_menu_count">{$details.addons}</span> </a></li>
        </ul>
