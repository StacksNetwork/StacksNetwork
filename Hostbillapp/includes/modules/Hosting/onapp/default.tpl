<tr><td id="getvaluesloader">{if $test_connection_result}
    ...
    <li><a href="#" class="disabled" onclick="load_onapp_section('privnetwork')">Private Network</a></li>
        ...
        <div class="onapp_opt {if $default.option10=='Single Machine, autocreation'}onapp_active{/if}">
            <table border="0" width="500">
                <tr>
                    ...
                    <td class="odescr">
                        <h3>Single VPS</h3>
                        <div class="graylabel">One account in HostBill = 1 virtual machine in OnApp</div>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <table border="0" cellspacing="0" cellpadding="6" width="100%" >
            ...
            <tr class="odesc_ odesc_cloud_vm">
                ...
                <td>
                    ...
                    <span class="fs11"><input type="checkbox" class="formchecker"  rel="privnetwork"> Allow client to enable during order</span>
                </td>
            ...
            <tr>
                <td width="160"><label>HVZ Network Join Name</label></td>
                <td ><input type="text" size="10" name="options[bondname]" value="{$default.bondname}" id="bondname">
            </td>
            </tr>
            <tr class="odesc_ odesc_cloud_vm">
                <td></td>
                <td>
                    <div class="graylabel">
                        ...
                        &nbsp;- provide interface name used in Hypervisor Zone Network Joins (/settings/hypervisor_zones/<em>HVZID</em>/network_joins)
                    </div>
                </td>
            </tr>
            {else}
    ...
    <div class="onapptab form" id="finish_tab">
        <table border="0" cellspacing="0" width="100%" cellpadding="6">
            ...
            <tr>
                ...
                <td valign="top">
                     Your OnApp package is ready to be purchased. <br/>
