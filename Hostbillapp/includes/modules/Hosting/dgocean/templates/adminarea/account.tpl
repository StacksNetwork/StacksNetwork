...
<form action="" method="post" id="account_form" >
    ...
    <div id="ticketbody" >
        ...
        <div id="client_nav">
            ...
            <div class="left">
                <span class="left" style="padding-top:5px;padding-left:5px;"><strong>{$details.lastname} {$details.firstname}的:</strong>&nbsp;&nbsp;</span>
        ...
        <ul class="tabs" id="tabbedmenu">
            ...
            <li class="tpicker"><a href="#tab2" onclick="return false">虚拟机</a></li>
