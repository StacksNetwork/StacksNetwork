<div id="formcontainer">
    <div id="formloader" style="background:#fff;padding:10px;"> <form action="?cmd=module&module={$moduleid}&do=vendors&vendor_id={$vendor.id}&make=editvendor" method="post" id="addcolocation">
            ...
            <div class="tabb colo_floor">
                <h3 style="margin:0px;">编辑供应商详情: {$vendor.name}</h3>
    ...
    <div class="dark_shelf dbottom">
        ...
        <div class="right">
            <span id="savechanges" >
                <span class="bcontainer " ><a class="new_control greenbtn" href="#" onclick="$('#addcolocation').submit(); return false"><span><b>保存供应商详情</b></span></a></span>
                <span >{$lang.Or}</span>
            </span>
