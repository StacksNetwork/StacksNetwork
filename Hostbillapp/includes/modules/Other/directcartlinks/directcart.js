    ...
    (function($) { // start jixedbar's anonymous function
        ...
        $.fn.jixedbar = function(options) {
            ...
            this.each(function() {
                ...
                $("#jx-hid-con-id").html('<li alt="隐藏工具栏"><a id="jx-hid-btn-id" class="' + hideIndicator + '"></a></li>');
			 ...
			 */
                ...
                $("#jx-uhid-itm-id").html('<li alt="显示工具栏"><a id="jx-uhid-btn-id" class="' + unhideIndicator + '"></a></li>');
...
var fndirect=function() {
  $('body').append('<div id="jixedbar">'
     + '<ul><li title="How to"><a href="http://www.stacksnet.com/templates/common/stacksnetwork/directlink.swf" target="_blank"><img src="templates/default/img/information-white.png" alt="" /></a></li></ul>'
      +  '<span class="jx-separator-left"></span>'
		+'<ul><li title="转存购物车内容为可重复调用的直通车链接"><a href="#" id="generate_link"><img src="includes/types/onappcloud/images/block--plus.png" alt="购物直通车链接" /></a></li></ul>'
       + '<span class="jx-separator-left"></span>'
