...
if ($imgtype == "historical")
{
  ...
  //$lineplot_allow->SetLegend("平均每 ".$imgtype);
  $lineplot_allow->SetLegend("平均");
  $lineplot_allow->SetColor('black');
  $lineplot_allow->SetWeight(1);
