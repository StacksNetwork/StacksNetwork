...
<div class="row">
  <div class="col-md-6">
    <div class="well info_box">
      <div class="title"><i class="oicon-key"></i> 验证</div>
      <form id="edit" name="edit" method="post" action="" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-actions">
            <button type="submit" class="btn btn-primary" name="submit" value="save"><i class="icon-ok icon-white"></i> 保存密码</button>
          </div>
        </fieldset>
      </form>
    </div>
