...
else
{
  ...
  $navbar['options_right']['details']['text'] = '无图像';
  ...
  echo('<tr><th></th><th></th><th>本地地址</th><th></th><th>节点地址</th><th>类型</th><th>家族</th><th>远程</th><th>状态</th><th style="width: 200px;">运行时间/更新</th></tr>');
  echo('</thead>');
