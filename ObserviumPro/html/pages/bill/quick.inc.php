...
switch($vars['tab'])
{
  ...
  case "24hour":
    ...
    $graph .= "&amp;width=1150&amp;height=300&amp;total=1'>";
    break;
...
<div class="tabBox">
  <ul class="nav nav-tabs" id="quickBillTab">
    ...
    <li class="<?php echo($active['24hour']); ?>"><a href="<?php echo($links['24hour']); ?>">24小时显示</a></li>
    <li class="<?php echo($active['monthly']); ?>"><a href="<?php echo($links['monthly']); ?>">月度显示</a></li>
    <li class="<?php echo($active['previous']); ?>"><a href="<?php echo($links['previous']); ?>">以前的计费显示</a></li>
  </ul>
