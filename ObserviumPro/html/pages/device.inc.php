...
if (isset($cache['devices']['id'][$vars['device']]) || $permit_ports)
{
  ...
  if (device_permitted($device['device_id']))
  {
    ...
    if ($health)
    {
      $navbar['options']['health'] = array('text' => '系统健康', 'icon' => 'oicon-system-monitor');
    }
    ...
    {
      $navbar['options']['collectd'] = array('text' => '系统性能', 'icon' => 'oicon-chart-up-color');
    }
    ...
    {
      $navbar['options']['printing'] = array('text' => '打印机', 'icon' => 'oicon-printer-color');
    }

    // Always print logs tab
    $navbar['options']['logs'] = array('text' => '日志', 'icon' => 'oicon-clipboard-audit');
