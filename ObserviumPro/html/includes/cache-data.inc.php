...
// CEF
$routing['cef']['count'] = dbFetchCell("SELECT COUNT(`cef_switching_id`) FROM `cef_switching` WHERE 1 ".$cache['where']['devices_permitted']);
// VRF
$routing['vrf']['count'] = dbFetchCell("SELECT COUNT(`vrf_id`) FROM `vrfs` WHERE 1 ".$cache['where']['devices_permitted']);
