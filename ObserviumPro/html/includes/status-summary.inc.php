...
<table class="table table-bordered table-condensed-more table-rounded table-striped">
  ...
  <tbody>
    <tr class="<?php echo($devices['class']); ?>">
      ...
      <td><a class="red" href="<?php echo(generate_url(array('page' => 'devices', 'status' => '0'))); ?>"><?php echo($devices['down']) ?> 异常</a></td>
    ...
    <tr class="<?php echo($ports['class']) ?>">
      ...
      <td><a class="red" href="<?php echo(generate_url(array('page' => 'ports', 'state' => 'down'))); ?>"><?php echo($ports['down']) ?> 异常 </a></td>
    ...
    <tr class="<?php echo($sensors['class']) ?>">
      ...
      <td><a class="red"   href="<?php echo(generate_url(array('page' => 'health'))); ?>"><?php echo($sensors['alert']) ?> 报警 </a></td>
...
if (OBSERVIUM_EDITION != 'community')
{
  ...
  if ($check['entity_status']['up'] == count($check['entities']))
  {
    ...
    $check['class']  = "red"; $check['table_tab_colour'] = "#cc0000"; $check['html_row_class'] = "错误";
  } elseif($check['entity_status']['delay'] > '0') {
    $check['class']  = "orange"; $check['table_tab_colour'] = "#ff6600"; $check['html_row_class'] = "警告";
  } elseif($check['entity_status']['suppress'] > '0') {
    $check['class']  = "purple"; $check['table_tab_colour'] = "#740074"; $check['html_row_class'] = "限速";
  } elseif($check['entity_status']['up'] > '0') {
    $check['class']  = "green"; $check['table_tab_colour'] = "#194b7f"; $check['html_row_class'] = "";
  } else {
    $check['entity_status']['class']  = "gray"; $check['table_tab_colour'] = "#555555"; $check['html_row_class'] = "禁用";
  }
