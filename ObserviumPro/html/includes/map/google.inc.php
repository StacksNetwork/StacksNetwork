  ...
  <script type='text/javascript'>
    ...
    function drawRegionsMap() {
      ...
      data.addRows([
        ...
        {
          $location_name = ($location === '' ? OBS_VAR_UNSET : strtr(htmlspecialchars($location), "'", "`"));
          ...
          if ($down > 0)
          {
            $locations_down[] = "[$lat, $lon, '$location_name', $down, ".$count*$down.", '".count($devices_up). " 设备正常, " . count($devices_down). " 设备异常: (". implode(", ", $devices_down).")', '$location_url']";
          } else if ($count) {
