...
$cmd      = "snmpget -O qv " . snmp_gen_auth($device) . " " . $device['hostname'].":".$device['snmp_port'] . " 1.3.6.1.2.1.7526.2.4";
...
$cmda = "snmpget -O qv " . snmp_gen_auth($device) . " " . $device['hostname'].":".$device['snmp_port'] . " 1.3.6.1.2.1.7526.2.1.1 1.3.6.1.2.1.7526.2.1.2 1.3.6.1.2.1.7526.2.2.1 1.3.6.1.2.1.7526.2.2.2";
$cmdb = "snmpget -O qv " . snmp_gen_auth($device) . " " . $device['hostname'].":".$device['snmp_port'] . " 1.3.6.1.2.1.7526.2.5 1.3.6.1.2.1.7526.2.6";
#echo($cmda);
$snmpdata = `$cmda`;
$snmpdatab = `$cmdb`;
