...
$i++;
$config['device_types'][$i]['text'] = '视频设备';
...
$i++;
$config['device_types'][$i]['text'] = '存储设备';
...
$config['ipmi']['userlevels']['USER']          = array('text' => '用户');
$config['ipmi']['userlevels']['OPERATOR']      = array('text' => '操作员');
$config['ipmi']['userlevels']['ADMINISTRATOR'] = array('text' => '管理员');
$config['ipmi']['userlevels']['CALLBACK']      = array('text' => '复查');
