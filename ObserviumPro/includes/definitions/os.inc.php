...
$config['os'][$os]['snmp']['max-rep']       = 100;
$config['os'][$os]['over'][0]['graph']      = "device_bits";
$config['os'][$os]['over'][0]['text']       = "流量";
$config['os'][$os]['over'][1]['graph']      = "device_processor";
$config['os'][$os]['over'][1]['text']       = "处理器";
$config['os'][$os]['over'][2]['graph']      = "device_mempool";
$config['os'][$os]['over'][2]['text']       = "内存";
...
$config['os'][$os]['ifname']                = 1;
$config['os'][$os]['sysObjectID'][]         = ".1.3.6.1.4.1.5624.2.1."; // Warning intersects with some Extreme Networks devices
$config['os'][$os]['sysObjectID'][]         = ".1.3.6.1.4.1.5624.2.2.";

$os = "enterasys-wl";
$config['os'][$os]['text']                  = "Enterasys Wireless Controller";
$config['os'][$os]['type']                  = "wireless";
$config['os'][$os]['icon']                  = "enterasys";
#$config['os'][$os]['ifname']                = 1;
